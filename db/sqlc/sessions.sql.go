...
func (q *Queries) BlockSession(ctx context.Context, arg BlockSessionParams) (Sessions, error) {
	row := q.db.QueryRowContext(ctx, blockSession, arg.IsBlocked, arg.Username)
	var i Sessions
	err := row.Scan(
		&i.ID,
		&i.Username,
